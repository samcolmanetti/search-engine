...
Bugs 1–6 were fixed together on branch `fix/known-bugs`, with one commit per bug.
...
- [x] 6 Store the stem in `TermInfo.term` (approved; there is no existing database to migrate)
